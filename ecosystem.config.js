  ...
  apps: [
    {
      ...
      script: "/Users/aniksingal/cortextos/dist/daemon.js",
      args: '--instance ' + (process.env.CTX_INSTANCE_ID || "default"),
      cwd: "/Users/aniksingal/cortextos",
      env: {
        CTX_INSTANCE_ID: process.env.CTX_INSTANCE_ID || "default",
        CTX_ROOT: process.env.CTX_ROOT || "/Users/aniksingal/.cortextos/default",
        CTX_FRAMEWORK_ROOT: "/Users/aniksingal/cortextos",
        CTX_PROJECT_ROOT: "/Users/aniksingal/cortextos",
        CTX_ORG: process.env.CTX_ORG || "ugenticai",
        NODE_EXTRA_CA_CERTS: "/Users/aniksingal/.cortextos/default/system-certs.pem",
      },
      max_restarts: 50,
      restart_delay: 5000,
      autorestart: true,
    },
    {
      ...
      script: "npm",
      args: "run dev",
      cwd: "/Users/aniksingal/cortextos/dashboard",
      env: {
